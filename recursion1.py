...
def countX(strg):
    if strg == "":
        ...
        return 1 + countX(strg[1:])
    else:
        return 0 + countX(strg[1:])
...
def countHi(strg):
    if strg == "":
        ...
        return 1 + countHi(strg[1:])
    else:
        return 0 + countHi(strg[1:])
...
def array11(nums, index):
    if len(nums) == 0:
        ...
        return 1 + array11(nums[1:], 0)
    else:
        return 0 + array11(nums[1:], 0)
...
def array220(nums, index):
    if len(nums) <= 1:
        return 0
    elif nums[1] == (nums[0]*10):
        return 1 
    else:
        return 0 + array220(nums[1:], 0)
...
def endX(strg):
    if len(strg) <= 1:
        ...
        return (endX(strg[1:])) + "x"
    else:
        return strg[0] + (endX(strg[1:]))
...
def countPairs(strg):
    if len(strg) <= 2:
        ...
        return 1 + (countPairs(strg[1:]))
    else:
        return 0 + (countPairs(strg[1:]))
...
def countAbc(strg):
    if len(strg) <= 2:
        return 0
    elif strg[:3] == "abc" or strg[:3] == "aba":
        return 1 + (countAbc(strg[1:]))
    else:
        return 0 + (countAbc(strg[1:]))    
...
def count11(strg):
    if len(strg) <= 1:
        return 0
    elif strg[0] == "1" and strg[1] == "1":
        return 1 + (count11(strg[2:]))
    else:
        return 0 + (count11(strg[1:]))      
...
def nestParen(str):
    if len(str) == 0:
        ...
        return True and nestParen(str[1:-1])
    elif str[0] != str[:-1]:
        return False
...
def strCopies(str, sub, n):
    if str == "":
        return False
    if 0 + strCopies(str[1:], sub, n) >= n:
        return True
    elif str[0:len(sub)] == sub:
        return 1 + strCopies(str[1:], sub, n)
    else:
        return False
...
def strDist(str, sub):
    ...
    if len(str) < len(sub):
        return 0
    elif "".join(s[:len(sub) + 1]) == sub:
        return 1 + strDist(str[1:], sub)
    else:
        return 0 + strDist(str[1:], sub)     
